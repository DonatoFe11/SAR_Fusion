...
class DeformableDetrFusionFAMBackbone(nn.Module):
    """
...
class DeformableDetrFusionFAMModel(DeformableDetrModel):
    """
    ...
    def __init__(
        ...
        self.backbone = DeformableDetrFusionFAMBackbone(
            config,
            use_fam=use_fam,
...
class DeformableDetrFusionFAMForObjectDetection(DeformableDetrForObjectDetection):
    """
    ...
    def __init__(
        ...
        super().__init__(config)
        self.model = DeformableDetrFusionFAMModel(
            config,
            use_fam=use_fam,
            freeze_fam=freeze_fam,
            ir_dropout_rate=ir_dropout_rate,
