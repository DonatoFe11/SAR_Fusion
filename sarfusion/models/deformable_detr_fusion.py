...
# DEFORMABLE DETR FUSION BACKBONE - Channel Concatenation
...
# DEFORMABLE DETR MODEL - Uses Deformable DETR as base
...
class DeformableDetrFusionForObjectDetection(DeformableDetrForObjectDetection):
    """
    Deformable DETR model for object detection with RGB-IR fusion.
    """
    
    def __init__(self, config: DeformableDetrConfig):
        super().__init__(config)
        # Replace model with Deformable DETR fusion model
