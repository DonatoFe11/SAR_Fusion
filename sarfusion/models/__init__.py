...
from sarfusion.models.detr import DeformableDetr, Detr, FusionDetr, RTDetr, FusionRTDetr, FusionRTDetrHistorical, FusionRTDetrCMX, FusionRTDetrCMXHybrid, FusionDeformableDetr, FusionDino
...
def build_fusion_rt_detr_historical(threshold=0.9, id2label=None, use_fam=False):
    # keep use_fam in signature for config compatibility, ignored by historical model
    return FusionRTDetrHistorical(threshold=threshold, id2label=id2label)
...
MODEL_REGISTRY = {
    ...
    "fusion_rtdetr_historical": build_fusion_rt_detr_historical,
