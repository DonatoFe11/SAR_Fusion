...
for every delta, including mixed consistency and box-guided alignment.
...
\begin{table}[htbp]
  \centering
  \caption{Final-epoch validation diagnostic for consistency and box-guided
  alignment. Values are epoch-10 \texttt{latest} \mapfifty{} over five seeds;
  these scores do not replace the best-checkpoint promotion criterion.}
