...
global \(800\times800\), zero-offset initialization, post-FAM gating, scalar
residual, mixed-consistency, and box-guided variants. Reliability-Conditioned
Residual Alignment (RCRA) is the only candidate promoted from Stage A. In
matched full-data Stage B, it
